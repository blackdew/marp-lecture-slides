...
| 타임라인 | 흐름 파악 | 세부 부족 | 프로세스 보고 |
| 문제-해결 | 명확한 구조 | 형식적 | 이슈 대응 |
...
**A팀:** "우리는 효율을 중시해" → 불릿 포인트 선택

**B팀:** "우리는 공감을 중시해" → 스토리텔링 선택

**C팀:** "우리는 객관성을 중시해" → 표 형식 선택
...
여러 날짜 형식 중 **내가 선택**:
- YYYY-MM-DD (ISO 표준) ← 선택!
- DD/MM/YYYY (유럽식)
- MM/DD/YYYY (미국식)

> **Agent가 옵션을 제시하고, 나의 가치로 선택했습니다**
