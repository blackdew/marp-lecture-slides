...
| **4** | 실전 실습 | 35분 | 역할별 실습 + 바이브 코딩 |
| **5** | 마무리 | 15분 | AI 시대 경쟁력을 위한 조언 |
...
**역할별 활용 예시**:
- 학생: 과제 발표 자료, 팀프로젝트 페이지, 포트폴리오
- 대학원생: 논문 정리 페이지, 연구 자료 아카이브
- 교직원: 부서 소개 페이지, 업무 보고 자료
...
"AI가 추천한 전공도 나의 가치관과 꿈에 맞는지 판단하는 건 나"
...
"AI가 제시한 논문 주제도 내 연구자로서의 철학과 맞는지는 내가 결정"
...
"AI가 만든 문서도 내 이름으로 나가는 만큼 최종 검토와 승인은 내 책임"
...
"애자일 방법론 리포트, A4 5장, 학술적 톤" → 정확한 결과물
...
"딥러닝, 이미지 분류, 2023년 이후, 의료 영상" → 원하는 논문만 필터링
...
"회의록, 참석자, 안건, 결정사항, 할 일 목록 포함" → 한 번에 완성
...
| 역할 | 상황 | AI 활용 | 내 역할 |
|------|------|---------|---------|
| **학부생** | 팀프로젝트 회의 | AI가 회의록 초안 작성 | 핵심 결정사항 확인 |
| **대학원생** | 실험 진행 | AI가 실험 노트 구조화 | 분석과 해석 추가 |
| **교직원** | 부서 회의 | AI가 회의록 + 할 일 추천 | 최종 검토 및 배포 |
...
<div class="success">
이 3가지가 <strong>AI 시대의 핵심 역량</strong>입니다!<br/>
...
| **C: 회의록 자동 작성** | 교직원 | 회의록 자동 생성 도구 체험 |

<div class="highlight">
자신의 역할에 맞는 트랙을 선택하여 실습하세요. 시간이 남으면 다른 트랙도 체험 가능합니다.
</div>

---

## 실습 4-1A: 학업 도우미 (학부생 트랙)
...
**주의**: Agent가 만든 내용을 그대로 제출하면 표절. **AI 결과물 + 나의 분석/의견 = 진짜 리포트**

---

## 실습 4-1B: 논문 탐색 (대학원생 트랙)
...
1. [SciSpace](https://typeset.io/) 접속
2. 연구 주제 검색 (예: "deep learning image classification")
3. 관련 논문 5편 선택
4. AI가 각 논문을 한 줄로 요약

### Connected Papers 활용

1. [Connected Papers](https://www.connectedpapers.com/) 접속
2. 핵심 논문 1개 입력
3. 논문 간 관계 그래프 확인
4. 관련 논문 탐색

<div class="success">
<strong>효과</strong>: Deep Research 기능 활용 시 리서치 시간 80% 단축 보고
</div>

---

## 실습 4-1C: 회의록 자동 작성 (교직원 트랙)
...
**추천 도구**: **클로바노트** (월 600분 무료)

### 클로바노트 활용

1. [클로바노트](https://naver.worksmobile.com/products/clovanote/) 접속
2. 회의 녹음 파일 업로드 (또는 실시간 녹음)
3. AI가 음성 인식 → 회의록 자동 생성
4. 주요 내용 요약, 할 일 추천 확인

---

## 실습 4-1C: 프롬프트로 회의록 정리
...
meeting_minutes.md로 저장해줘.
```

**결과물**: `meeting_minutes.md`

<div class="highlight">
회의록 자동화로 필기 부담 제거 → 회의 집중도 향상
</div>
...
| 난이도 | 프로젝트 | 설명 |
|--------|---------|------|
| **쉬움** | 시간표/일정 관리 페이지 | 요일별 시간표 또는 일정 관리 |
...
```
월~금 시간표(또는 일정)를 보여주는 HTML 페이지를 만들어줘.
표 형식으로, 시간대별로 과목명(또는 일정명)과 장소를 표시.
...
- **Deep Research** - 리서치 시간 80% 단축
- **문헌 관리** - Typeset.io 자동 형식 정리
- **논문 그래프 시각화** - Connected Papers
...
**공통**: AI가 10개의 옵션을 만들어도, 고르는 건 사람

- 학부생: AI가 만든 리포트도 스스로 검증하고 선택
- 대학원생: AI가 제시한 논문도 직접 읽고 판단
- 교직원: AI가 작성한 문서도 최종 검토와 승인은 본인

**핵심**: "왜 이걸 선택했는가"를 설명할 수 있어야 합니다
