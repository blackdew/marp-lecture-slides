...
| 언제 | 어떻게 | 무엇을 |
|-----|-------|--------|
| 복잡한 탐색 | 명확한 프롬프트 | 자율적 수행 |
| 병렬 처리 | Agent 유형 선택 | 보고서 결과 |
| 컨텍스트 절약 | 병렬 실행 | 시간 절약 |
...
| 기본 Commands | Agent 활용 | Hooks 설정 |
| 파일 읽기/쓰기 | Plan Mode | 워크플로우 최적화 |
...
|--------|----------|--------|
| 특정 작업 전문화 | 반복 작업 자동화 | 복잡한 작업 위임 |
| 자동 실행 | 슬래시 명령어 | 병렬 실행 |
| PDF, Excel 등 | 커스터마이징 | 컨텍스트 절약 |
