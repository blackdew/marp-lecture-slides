...
| Part | 주제 | 시간 | 핵심 내용 |
|------|------|------|-----------|
| **1** | 시작하기 | 30분 | Agent 개념, CLI 기초, 설치 및 첫 대화 |
| **2** | 실습 | 40분 | 환영 페이지 만들기, 폴더 정리, Plan 모드 체험 |
| **3** | AI 시대 우리의 3가지 역할 | 40분 | 선택, 계획, 문서화의 중요성 |
| **4** | 실전 자동화 | 95분 | CSV 정리, PDF 요약, 이메일 작성, 도구 만들기 |
| **5** | 개인 해커톤 | 40분 | 자유 주제로 나만의 프로젝트 만들기 |
| **6** | 회고와 다음 단계 | 20분 | 실전 적용 팁, 심화 학습 가이드 |

**오늘의 핵심 메시지**: "Agent = 도구를 쓸 줄 아는 똑똑한 동료"
...
1. **실습 4-1**: CSV 데이터 정리 (30분) ⭐⭐
2. **실습 4-2**: PDF 문서 요약 (30분) ⭐⭐
3. **휴식** (15분)
4. **실습 4-3**: 상황별 메일 작성 (30분) ⭐⭐⭐
5. **실습 4-4**: 즉석 도구 만들기 (30분) ⭐⭐⭐

### 공통 원칙

- 모든 실습 = **기본 과제 (20분) + 도전 과제 (10분)**
